      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" value="{{old('surname')}}" type="text" aria-describedby="surnamenameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="mobile" name="mobile" value="{{old('mobile')}}" type="text" aria-describedby="mobileHelp" placeholder="Enter mobile">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="age" name="age" value="{{old('age')}}" type="text" aria-describedby="ageHelp" placeholder="Enter age">
             @if ($errors->has('age'))
                    <span class="text-danger">{{ 
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="address" name="address" value="{{old('address')}}" type="text" aria-describedby="addressHelp" placeholder="Enter address">
